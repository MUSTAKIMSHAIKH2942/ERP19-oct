<%@ Page Language="VB"  Theme="BlueChip" EnableEventValidation="false"  AutoEventWireup="false" CodeFile="ViewSampleRequisition.aspx.vb"
    ...
    <table id="Table1" class="mainTable" align="center">
        ...
        <tr>
            <td class="tabledata" align="right">
                <b>Sample No/Department/Product.</b>
                ...
                <a id="a1" runat="server" causesvalidation="false" style="cursor: hand;" class="searchImage"
                    ...
                    <img src="../Images/Search.gif" id="imgbtnSearch" border="0" runat="server" class="searchImage" /></a><asp:Button ID="btnExportExcel" runat="server" Text="Export To Excel" />
            </td>
        </tr>
    </table>
    ...
    <asp:DataGrid ID="dgRmcplRequisition"   Width=2300px runat="server" HorizontalAlign="center" DataKeyField="RMCPL_TID">
        <Columns>
            <asp:TemplateColumn SortExpression="RMCPL_SR_NO" HeaderText="Sample No.">
              ...
              <asp:TemplateColumn SortExpression="OrganisationName" HeaderText="CustomerName">
                <ItemTemplate>
                    <asp:Label ID="lblOrganisationName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.OrganisationName")%>'> </asp:Label>
                </ItemTemplate>
            </asp:TemplateColumn>
          ...
          <%--  <asp:TemplateColumn SortExpression="remarks" HeaderText="remarks">
            ...
            <asp:TemplateColumn SortExpression="Department" HeaderText="Department">
                ...
                <asp:TemplateColumn SortExpression="AllRemarks" HeaderText="All Remarks">
                <ItemStyle></ItemStyle>
                <ItemTemplate>
                    <asp:Label ID="lblAllRemarks" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "AllRemarks") %>'></asp:Label> <asp:LinkButton ID="lnkbtnRemarks" runat="server"   ForeColor=Red  Text="Add Remark"   CausesValidation="false"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateColumn>
           <%-- <asp:TemplateColumn SortExpression="SalesManager" HeaderText="SalesManager">
            ...
            <asp:TemplateColumn HeaderStyle-Width="100px" HeaderText="Courier Service Name">
                <ItemTemplate>
                    <asp:Label ID="lblCourierServiceName" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CourierServiceName") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateColumn>

            <asp:TemplateColumn HeaderStyle-Width="100px" HeaderText="Tracking Number">
                <ItemTemplate>
                    <asp:Label ID="lblCourierTrackingNo" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CourierTrackingNo") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateColumn>

            <asp:TemplateColumn HeaderStyle-Width="100px" HeaderText="Courier Date">
                <ItemTemplate>
                    <asp:Label ID="lblCourierDate" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.CourierDate", "{0:yyyy-MM-dd}") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateColumn>

            <asp:TemplateColumn HeaderStyle-Width="100px" HeaderText="Estimated Delivery Date">
                <ItemTemplate>
                    <asp:Label ID="lblEstimatedDateOfDelivery" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.EstimatedDateOfDelivery", "{0:yyyy-MM-dd}") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateColumn>
           ...
           <asp:TemplateColumn HeaderStyle-Width="100px" HeaderText="If Delay<br>(Anyone)">
             ...
             <asp:TemplateColumn HeaderStyle-Width="100px" HeaderText="Delete SampleRequizition">
                <ItemStyle></ItemStyle>
                <ItemTemplate>
                    <asp:Label ID="lblDelete" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DeleteID")%>'> </asp:Label>
                    <asp:LinkButton ID="lnkDelete" runat="server" ForeColor="Red" Text="Pending" CausesValidation="false"></asp:LinkButton>
                </ItemTemplate>
             </asp:TemplateColumn>
        </Columns>
    </asp:DataGrid>
